...
- **国内用户**——人民币基础换算为 ⭐️ 1 AIFast Credit = 0.75元；常用档位为 ⭐️ 100 Credits 享9.90折、⭐️ 500 Credits 享9.85折、⭐️ 1000 Credits 享9.80折，支付方式、折扣和最终结算以控制台为准
- **国际用户**——支持信用卡或加密货币充值。信用卡按 ⭐️ 1 AIFast Credit = 0.75元人民币换算，按 2026-07-17 欧洲央行参考汇率约合 US$0.11；加密货币换算为 ⭐️ 1 AIFast Credit = 0.07 USDC 或 0.07 USDT

⭐️ AIFast Credits 是平台余额与模型计价的使用单位，不是美元、法定货币或加密货币代币。信用卡最终扣款以结账页汇率、支付通道和发卡行费用为准；加密货币充值前应在控制台核对当前支持的链和操作指引。当前控制台费用不等于官方模型价格，费用数据会随供应商定价和平台策略变化。
